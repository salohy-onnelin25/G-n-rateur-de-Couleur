...
const cssColors = [
    ...
    { name: "Cyan", hex: "#00FFFF" }, { name: "SkyBlue", hex: "#87CEEB" },
    { name: "Blue", hex: "#0000FF" }, { name: "Navy", hex: "#000080" },
    { name: "Indigo", hex: "#4B0082" }, { name: "Purple", hex: "#800080" },
    { name: "Pink", hex: "#FFC0CB" }, { name: "Maroon", hex: "#800000" },
    { name: "Brown", hex: "#A52A2A" }, { name: "Black", hex: "#000000" },
    { name: "Gray", hex: "#808080" }, { name: "Silver", hex: "#C0C0C0" },
    { name: "White", hex: "#FFFFFF" }, { name: "Coral", hex: "#FF7F50" },
    { name: "Khaki", hex: "#F0E68C" }, { name: "Salmon", hex: "#FA8072" },
...
function updateColorDisplay() {
    ...
    const isDark = (parseInt(currentColor.hex.substring(1), 16) > 0xFFFFFF / 2);
...
body.addEventListener('touchend', (e) => {
    ...
    if (touchStartX > rightEdgeThreshold && swipeDistance > swipeThreshold && !sidebar.classList.contains('open')) {
        toggleSidebar(); 
    } 

    else if (sidebar.classList.contains('open') && touchEndX - touchStartX > swipeThreshold) {
         toggleSidebar(); 
    }
});
